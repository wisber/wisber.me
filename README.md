...
This is the home of the wisber.me website and blog.
...
name: 'twsl'
pronouns: 'he/him'
avatar: 'https://avatars.githubusercontent.com/u/45483159?s=96&v=4'
bio: 'Change is the only constant in life'
website: 'https://twsl.dev'
bsky: 'https://bsky.app/profile/twsl.bsky.social'
github: 'https://github.com/twsl'
mail: 'twsl@wisber.me'
---
```
...
| `bsky`  | `string.url()`                             | Must be a valid URL.                                                                                                                                                     | Optional |
